...
class Config:
    def __init__(self):
        ...
        self.youtube_cookies_file = (
            os.getenv("YOUTUBE_COOKIES_FILE") or ""
        ).strip() or None
        ...
        self.max_video_duration = int(os.getenv("MAX_VIDEO_DURATION", "14400"))
        ...
        self.fast_mode_min_clips = int(os.getenv("FAST_MODE_MIN_CLIPS", "6"))
        self.fast_mode_max_clips = int(os.getenv("FAST_MODE_MAX_CLIPS", "8"))
